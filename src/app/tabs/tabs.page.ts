...
import { chatboxOutline, heartOutline, homeOutline, personCircleOutline, searchOutline, notificationsOutline, locationOutline, 
  ...
  helpCircleOutline,linkOutline,lockClosedOutline,navigateCircleOutline,createOutline,chevronForwardOutline,ellipsisHorizontalOutline,closeOutline} from 'ionicons/icons';
...
export class TabsPage {
  ...
  constructor() {
    addIcons({ homeOutline, searchOutline ,heartOutline, chatboxOutline, personCircleOutline, 
      ...
      lockClosedOutline,navigateCircleOutline, createOutline,chevronForwardOutline,ellipsisHorizontalOutline,closeOutline});
  }
}
